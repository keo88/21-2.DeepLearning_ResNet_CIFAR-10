...
class nn_mnist_classifier:
    ...
    def update_weights(self):
        ...
        self.fc2.update_weights(-self.v_w_fc2 * lr, -self.v_b_fc2.T * lr)
        self.fc1.update_weights(-self.v_w_fc1 * lr, -self.v_b_fc1.T * lr)
        self.conv_layer_1.update_weights(-self.v_w_cv1 * lr, -self.v_b_cv1 * lr)
